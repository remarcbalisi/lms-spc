...
<head>
    ...
    <link href="{{ asset('landing_page/vendor/simple-line-icons/css/simple-line-icons.css') }}" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="{{ asset('landing_page/css/stylish-portfolio.min.css') }}" rel="stylesheet">
...
<style>
    .masthead{
        background: linear-gradient(90deg, fade-out($white, 0.9) 0%, fade-out($white, 0.9) 100%), url('{{asset('storage/' . $landing_page->banner_image)}}');
    }
</style>
<!-- Header -->
<header class="masthead d-flex">
    <div class="container text-center my-auto">
        <h1 class="mb-1">St. Peter's College</h1>
        <h3 class="mb-5">
...
<script src="{{ asset('landing_page/js/stylish-portfolio.min.js') }}"></script>
