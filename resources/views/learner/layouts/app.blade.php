            ...
            {{--<div class="collapse navbar-collapse" id="navbarSupportedContent">--}}
                    ...
                    {{--@auth()--}}
                        {{--<li class="nav-item dropdown">--}}
                            ...
                            {{--<div class="dropdown-menu dropdown-menu-left" aria-labelledby="navbarDropdown">--}}
                                {{--<a class="dropdown-item" href="{{route('learner-my-class-list')}}">--}}
                                    {{--List--}}
                                {{--</a>--}}
                            {{--</div>--}}
                        {{--</li>--}}
                ...
                {{--<ul class="navbar-nav ml-auto">--}}
                    ...
                    {{--@else--}}
                        {{--<li class="nav-item dropdown">--}}
                            {{--<a id="navbarDropdown" class="nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>--}}
                                {{--{{ Auth::user()->fname }} {{ Auth::user()->lname }} <span class="badge badge-light">{{count($new_messages)}}</span><span class="caret"></span>--}}
                            {{--</a>--}}

                            {{--<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">--}}
                                {{--<a class="dropdown-item" href="{{route('learner-my-inbox')}}">--}}
                                    {{--Inbox <span class="badge badge-light">{{count($new_messages)}}</span>--}}
                                {{--</a>--}}
        ...
        -->
            ...
            <div class="sidebar-wrapper">
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item active  ">
                        <a class="nav-link" href="{{route('learner-my-class-list')}}">
            ...
            <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse justify-content-end">
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('learner-my-inbox')}}">
                                    <i class="material-icons">all_inbox</i> Inbox
